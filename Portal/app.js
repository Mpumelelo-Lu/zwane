...
const kyc = require(path.join(__dirname, 'public', 'Services', 'kycService'));
...
app.get('/api/kyc/user/:userId/status', (req, res) => {
  const result = kyc.getUserKycStatus(req.params.userId);
  res.json(result);
});
